...
<div class="container">
    <div class="row">
        <div class="col-12 pt-2">
           <a href="/stud" class="btn btn-outline-primary btn-sn">Go Bake</a>
           ...
           <form action="" method="session">
               ...
               <div class="row">
                   <div class="control-group col-12" >
                       ...
                       <div class="control-group col-12" >
                           <label for="courses_id">courses_id</label>
                           <input type="number" id="name" class="form-control" name="courses_id" placeholder="Enter courses_id"
                           value="{{ $session->courses_id }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="NameSessoin">NameSessoin</label>
                           <input type="text" id="NameSessoin" class="form-control" name="NameSessoin" placeholder="Enter NameSessoin" 
                           value="{{ $session->NameSessoin }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="Time">Time</label>
                           <input type="time" id="Time" class="form-control" name="Time" placeholder="Enter Time" 
                           value="{{ $session->Time }}" required>
                       </div>
                   <div class="row mt-2">
