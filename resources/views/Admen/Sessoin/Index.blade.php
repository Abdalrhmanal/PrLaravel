  ...
  <!-- partial -->
   <div class="container-fluid page-body-wrapper">
    ...
    <div class="container" style="width:70% ;padding: 10%;">
            <!-- card Session-->
            @forelse ($sessoins as $Secor)
      <div class="card" style="margin-top: 20px;background-color: rgba(2, 3, 20, 0.359);border-radius: 10%;">  
        <div class="card-body">
            {{-- <li> {{ $cor->id }} </li> --}}
          <h5 class="card-title">{{ $Secor->courses_id }}</h5>
          <h5 class="card-title">{{ $Secor->NameSessoin }}</h5>
          <p class="card-text" style="color: black">{{ $Secor->Time }}</p>
          <div class="card-body">
            <a href="/sess/{{ $Secor->id }}" class="btn btn-primary">Wotched</a>
            <a class="btn btn-primary" href="/sessoin/create/ses">Create</a>
