               ...
               <form action="" method="POST">
                   ...
                   <div class="row">
                       <div class="control-group col-12" >
                           ...
                           <input type="number" id="courses_id" class="form-control" name="courses_id" placeholder="Enter courses_id" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="NameSessoin">NameSessoin</label>
                           <input type="text" id="teachers" class="form-control" name="NameSessoin" placeholder="Enter NameSessoin" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="Time">Time</label>
                           <input type="time" id="Time" class="form-control" name="Time" placeholder="Enter Time" required>
                       </div>
                       <div class="row mt-2">
