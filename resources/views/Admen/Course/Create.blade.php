               ...
               <form action="" method="POST">
                   ...
                   <div class="row">
                       ...
                       <div class="control-group col-12" >
                           ...
                           <input type="text" id="teachers" class="form-control" name="teachers" placeholder="Enter teachers" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="small_desc">small_desc</label>
                           <input type="text" id="small_desc" class="form-control" name="small_desc" placeholder="Enter small_desc" required>
                       </div>
                       <div class="control-group col-12" >
                        <label for="desc">desc</label>
                        <input type="text" id="desc" class="form-control" name="desc" placeholder="Enter desc" required>
                        </div>
                        <div class="control-group col-12" >
                            <label for="img"> img</label>
                            <input type="txt" id="img" class="form-control" name="img" placeholder="Enter Link img" required>
                        </div>
