        ...
        <div class="col-4" style="padding: 5px;">
          <div class="card" style="width: 100%;" >
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">{{$cours->teachers_id}}</li>
              <li class="list-group-item">{{$cours->small_desc}}</li>
              <li class="list-group-item">{{$cours->desc}}</li>
            </ul>
            <div class="card-body">
              <button type="button" class="btn btn-secondary">regist</button>
              <a class="btn btn-primary" href="/sessoin/{{ $sessoins->id }}">Details</a> 
              <a class="btn btn-success" href="/cc/{{ $cours->id }}/ed">Edit</a> 
              <a class="btn btn-danger" href="/ccr/{{ $cours->id }}">Delete</a> 
            </div>
          </div>
        </div>
      </div>
