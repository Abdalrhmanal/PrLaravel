...
<div class="container">
    <div class="row">
        <div class="col-12 pt-2">
           <a href="/cc" class="btn btn-outline-primary btn-sn">Go Bake</a>
          <div class="border rounded nt-5 p-4">
           <h1> Edit a  Courses</h1>
           <p>Fille and a create Courses</p>
           <hr>
           <form action="" method="cours">
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="control-group col-12" >
                       <label for="title">Student Titlre</label>
                       <div class="control-group col-12" >
                        <label for="teachers_id">teachers_id</label>
                        <input type="number" id="teachers_id" class="form-control" name="teachers_id" placeholder="Enter teachers_id"
                        value="{{ $cours->teachers_id }}" required>
                    </div>
                    <div class="control-group col-12" >
                        <label for="name">name</label>
                        <input type="text" id="name" class="form-control" name="name" placeholder="Enter Name"
                        value="{{ $cours->name }}" required>
                    </div>
                       <div class="control-group col-12" >
                           <label for="small_desc">small_desc</label>
                           <input type="text" id="small_desc" class="form-control" name="small_desc" placeholder="Enter small_desc"
                           value="{{ $cours->small_desc }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="desc">desc</label>
                           <input type="text" id="desc" class="form-control" name="desc" placeholder="Enter desc" 
                           value="{{ $cours->desc }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="img">img</label>
                           <input type="text" id="img" class="form-control" name="img" placeholder="Enter Link img" 
                           value="{{ $cours->img }}" required>
                       </div>
                   <div class="row mt-2">
