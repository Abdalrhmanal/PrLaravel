    ...
    <div class="row">
        <div class="col-12 pt-2">
          ...
          <div class="border rounded nt-5 p-4">
           <h1> Edit a  Teachars</h1>
           <p>Fille and a create Teachars</p>
           <hr>
           <form action="" method="teach">
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="control-group col-12" >
                       ...
                       <div class="control-group col-12" >
                           ...
                           value="{{ $teach->name }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="phone">Email</label>
                           <input type="text" id="phone" class="form-control" name="phone" placeholder="Enter phone" 
                           value="{{ $teach->phone }}" required>
                       </div>
                       <div class="control-group col-12" >
                           <label for="specialty">specialty</label>
                           <input type="text" id="specialty" class="form-control" name="specialty" placeholder="Enter specialty" 
                           value="{{ $teach->specialty }}" required>
                       </div>
                       <div class="control-group col-12" >
                        <label for="img">img</label>
                        <input type="text" id="img" class="form-control" name="img" placeholder="Enter Link img" 
                        value="{{ $teach->img }}" required>
                    </div>
                   <div class="row mt-2">
