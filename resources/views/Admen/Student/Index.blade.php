...
<div class="container-scroller">
    ...
    <div class="container" style="width:70% ;padding: 10%;">
        <table class="table">
            <a class="btn btn-primary" href="/stud/create/std">Create</a> <br><br><br>
            <thead>
            <tr>
                <th scope="col">#</th>
            ...
            <tr>
                ...
                <td>
                    <div class="card-body">
                        ...
                        <a class="btn btn-success" href="/stud/{{ $std->id }}/ed">Edit</a> 
                        @csrf
                        <form  id="delete-form" action="/std/{{ $std->id }}" method="POST">
                            @method("DELETE")
                            @csrf
