          ...
          <li class="nav-item sidebar-user-actions">
            ...
            @csrf
             <div class="col-12 pt-2">
                <a href="/sessoin" class="btn btn-outline-primary btn-sn">Go Bake</a>
                <div class="container" style="margin-top: 40px;">
                    <!--Session video-->
                    <div class="ratio ratio-16x9">
                                                             {{-- {{ $detail->Video }} --}}
                           <iframe width="90%" height="90%" src="{{ $detail->Video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                      </div>
                </div>
                <div class="container" style="margin-top: 40px;">
                    <!--Session file-->
                                                                   {{-- {{ $detail->file }} --}}
                    <p class="text-body-emphasis" > <a class="link-primary" href="{{ $detail->file }}"><b><h4>This link file hear</h4></b></a></p>
                </div>
                <div class="container" style="margin-top: 40px;">
                    <!--Session Nutyfi-->
                    <p class="text-body-emphasis">{{ $detail->Notefy }}</p>
                
             <hr>
             {{-- <a href="/sess/{{ $detail->id }}/Edit" class="btn btn-outline-primary">Edit Session</a> --}}
                <br>
                <a class="btn btn-success" href="/sessoin">Details</a> <br>
